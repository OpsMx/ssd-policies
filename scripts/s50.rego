...
deny[{"alertMsg": msg, "suggestion": "Suggest to set the resource limits and optimize them.", "error": "", "exception": "", "alertStatus": alertStatus, "accountName": account}] {
	general_violation[{"msg": msg, "field": "containers"}]
	not policy_name in exception_list
	alertStatus := "active"
}

deny[{"alertMsg": msg, "suggestion": "Suggest to set the resource limits and optimize them.", "error": "", "exception": policy_name, "alertStatus": alertStatus, "accountName": account}] {
	general_violation[{"msg": msg, "field": "containers"}]
