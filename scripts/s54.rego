...
deny[{"alertMsg": msg, "suggestion": "Suggest to restrict the usage of AppArmor Profiles..", "error": "", "exception": "", "alertStatus": alertStatus, "accountName": account}] {
...
deny[{"alertMsg": msg, "suggestion": "Suggest to restrict the usage of AppArmor Profiles..", "error": "", "exception": policy_name, "alertStatus": alertStatus, "accountName": account}] {
	metadata := input.request.object.metadata
	container := input_containers[_]
	not input_apparmor_allowed(container, metadata)
