...
deny[{"alertMsg": msg, "error": error, "suggestion": sugg, "exception": "", "alertStatus": alertStatus, "accountName": scm_account}]{
...
deny[{"alertMsg": msg, "error": error, "suggestion": sugg, "exception": policy_name, "alertStatus": alertStatus, "accountName": scm_account}]{
	count(ssl_disabled_hooks) > 0
