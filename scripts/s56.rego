...
deny[{"alertMsg": msg, "suggestion": "Suggest to restrict the usage of Flex Volumes.", "error": "", "exception": "", "alertStatus": alertStatus, "accountName": account}] {
...
deny[{"alertMsg": msg, "suggestion": "Suggest to restrict the usage of Flex Volumes.", "error": "", "exception": policy_name, "alertStatus": alertStatus, "accountName": account}] {
	# spec.volumes field is immutable.
	not is_update(input.request)
